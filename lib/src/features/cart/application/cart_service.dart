...
class CartService {
  ...
  /// Function used to  move the cart item to wish list
  Future<void> moveCartItemToWishlist(ProductID productId) async {
    final wishlistService = ref.read(wishlistServiceProvider);

    await wishlistService.setProductInWishlist(productId);
