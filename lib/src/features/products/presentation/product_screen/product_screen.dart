...
class ProductDetails extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isWishlistItemAdded = (wishlist != null &&
        wishlist.wishlistProductsList.contains(product.id));
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: IconButton(
                  icon: isWishlistItemAdded ? const Icon( 
                    Icons.favorite,
                    color: Colors.red,
                  ) : const Icon(
